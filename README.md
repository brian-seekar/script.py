...
- to keep spirits reasonably high after my KIVA i decided to build something for myself. during a botathon (RAG_SHE) i found the os module interesting; it could apparently interact with files on your system. of course i used pathlib for this (mini)project because i'm trying to make sense of OOP.
